...
<div class="profile-header mb-4">
    <div class="d-flex justify-content-between align-items-start">
        <div>
            <div class="mb-1"><a href="<?php echo BASE_URL; ?>/index.php?page=providers" class="text-white-50 text-decoration-none small"><i class="bi bi-arrow-left me-1"></i>Back to Providers</a></div>
            <h4><?php echo htmlspecialchars($provider['name']); ?></h4>
            <?php if ($provider['contact_name']): ?><div class="text-white-50 small"><i class="bi bi-person me-1"></i><?php echo htmlspecialchars($provider['contact_name']); ?></div><?php endif; ?>
            <?php if ($provider['email']): ?><div class="text-white-50 small"><i class="bi bi-envelope me-1"></i><?php echo htmlspecialchars($provider['email']); ?></div><?php endif; ?>
            <?php if ($provider['phone']): ?><div class="text-white-50 small"><i class="bi bi-telephone me-1"></i><?php echo htmlspecialchars($provider['phone']); ?></div><?php endif; ?>
        </div>
        <div class="text-end">
            <button class="btn btn-sm btn-light me-1" data-bs-toggle="modal" data-bs-target="#addTxModal" onclick="setTxType('receivable')">
                <i class="bi bi-plus-circle me-1"></i>Add Receivable
            </button>
    ...
    <div class="col-md-3">
        <div class="card text-center">
            <div class="card-body">
                ...
                <div class="fw-bold fs-5 text-primary"><?php echo formatMoney($totalReceivable); ?></div>
            </div>
        </div>
    </div>
    <div class="col-md-3">
    ...
    <div class="col-md-3">
        <div class="card text-center">
            <div class="card-body">
                ...
                <div class="fw-bold fs-5 <?php echo $netBalance > 0 ? 'text-danger' : 'text-success'; ?>"><?php echo formatMoney($netBalance); ?></div>
            </div>
        </div>
    </div>
    <div class="col-md-3">
    ...
    <div class="tab-content">
                ...
                <table class="table table-hover mb-0">
                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td class="text-end running-balance <?php echo $tx['running_balance'] > 0 ? 'text-danger' : 'text-success'; ?>">
        ...
        <div class="tab-pane fade p-4" id="notes">
            <?php if ($provider['notes']): ?>
                <p><?php echo nl2br(htmlspecialchars($provider['notes'])); ?></p>
            <?php else: ?>
                <p class="text-muted">No notes for this provider.</p>
            <?php endif; ?>
        </div>
    </div>
</div>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="description" class="form-control" placeholder="e.g. Invoice #1234">
                        </div>
                        <div class="col-md-6">
